...
int main () {   
    ...
    Servo baseServo ("base", 5, -60, 60, 0, 0, true);
    Servo upperArmServo ("upper", 7, -30, 50, 0, -25, false);
    Servo lowerArmServo ("lower", 4, -90, 90, -90, 35, true);
    Servo fingerServo ("finger", 6, -90, 90, 90, -30, true);   
